...
<div class="jumbotron jumbotron-fluid jumb">
    <div class="container">
        ...
        <div class="form-group mx-sm-3 mb-2">
            ...
            <div class="input-group input-group-default mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default"><i class="fas fa-id-card-alt"></i>
        ...
        <div class="form-group mx-sm-3 mb-2">
            ...
            <div class="input-group input-group-default mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default"><i class="far fa-calendar-alt"></i>
        ...
        <div class="form-group mx-sm-3 mb-2">
            ...
            <div class="input-group input-group-default mb-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="inputGroup-sizing-default"><i class="fas fa-weight-hanging"></i>
